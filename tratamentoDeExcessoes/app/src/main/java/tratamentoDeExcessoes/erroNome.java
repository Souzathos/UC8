 ...
 */
public class erroNome extends javax.swing.JFrame {

    /**
     * Creates new form erroNome
     */
    public erroNome() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        campoNumero.setText("jTextField1");

        campoNumero2.setText("jTextField1");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String texto1 = campoNumero.getText();
        String texto2 = campoNumero2.getText();
        
        if(isDouble(texto1) && isDouble(texto2)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(erroNome.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private boolean isDouble(String texto1) {
